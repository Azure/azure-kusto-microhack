...
1. Challenge 0: What is Azure Data Explorer and when is it a good fit?
...
Azure Data Explorer capabilities are extended by other services built on its powerful query language, including [Azure Monitor logs](https://docs.microsoft.com/en-us/azure/log-analytics/), Application Insights, Time Series Insights, and Microsoft Defender for Endpoint

3. Challenge 1: Create ADX cluster
4. Challenge 2: Create integration with Azure services
5. Challenge 3: Ingest and transform data
6. Challenge 4: Retrieve stats on the ingested data
7. Challenge 5: Setup basic monitoring of the cluster

...
On the [Azure Cloud Shell](https://shell.azure.com/) run the following commands to deploy the solution:
  ...
  6. This is the expected result: <img src="/assets/images/Deployment_Check_CLI_Screenshot.png" width="1200">
...
5. Now from the Azure portal, open Event Hub that is created and check the graph "Messages" in the overview page. Note that the simulated devices messages should be flowing and messages should not be zero. <img src="/assets/images/Deployment_Check_EH_messages.png" width="1200">
